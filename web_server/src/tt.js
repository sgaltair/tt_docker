...
function finishGame() {
	...
	quote_text.textContent =
		"Click on restart to start the test again. All attempts are recorded.";
	...
	urlencoded.append("ip", publicIp);
	urlencoded.append("wpm", wpm);
	urlencoded.append("awpm", awpm);
	urlencoded.append("accuracypercent", accuracyVal);
	...
	fetch("http://isame-lab.com:8011/users", requestOptions)
